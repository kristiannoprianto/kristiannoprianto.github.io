# Hi, I'm Kristian Noprianto

Software Developer • Real-Time Systems • Scientific Computing • Backend
...
**B.Sc. Computer Science** --- Bina Nusantara University (GPA 3.78)\
**Diploma in Telecommunication Engineering** --- Telkom University (GPA
3.56)

## Skills

**Languages:** Python, JavaScript, C++, HTML, CSS\
**Frameworks:** Django, DRF, ReactJS, Tailwind, PyQt\
**Tools:** Docker, Git, Redis, PostgreSQL, MySQL, Ubuntu, Swagger\
**Technologies:** Paraview, Zabbix, Grafana, Arduino\
**Concepts:** Realtime Processing, API Development, Scientific
Computing, Data Visualization, Machine Learning\
**Soft Skills:** Leadership, Project Management, Problem-Solving,
Collaboration

## Intellectual Property

-   **PertaGAMANT** --- Geophysics passive seismic processing software
    (2023)\
-   **SPECTRAGAMA** --- Seismic processing application (2024)
...
kristiannoprianto66@gmail.com\
LinkedIn: linkedin.com/in/kristian-noprianto/\
GitHub: github.com/kristiannoprianto
